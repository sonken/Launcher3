...
public class InvariantDeviceProfile {
    ...
    InvariantDeviceProfile(Context context) {
        ...
        Log.i(this.getClass().getSimpleName(),"===>mimwidthDps:"+minWidthDps+" ,minHeightDps:"+minHeightDps);
        ArrayList<InvariantDeviceProfile> closestProfiles =
                findClosestDeviceProfiles(minWidthDps, minHeightDps, getPredefinedDeviceProfiles());
        Log.i(this.getClass().getSimpleName(),"==closeprofiles :"+closestProfiles.get(0).toShortString());
        InvariantDeviceProfile interpolatedDeviceProfileOut =
                invDistWeightedInterpolate(minWidthDps,  minHeightDps, closestProfiles);
        Log.i(this.getClass().getSimpleName(),"==interpolatedDeviceProfileOut :"+interpolatedDeviceProfileOut.toShortString());
    ...
    ArrayList<InvariantDeviceProfile> getPredefinedDeviceProfiles() {
        ...
        // 修改hotseat图标数量为5
        predefinedDeviceProfiles.add(new InvariantDeviceProfile("UBTECH p12",
                533, 853,     5, 6, 4, 5, 4, 72, 14.4f,  5, 72, R.xml.default_workspace_ubtech));
