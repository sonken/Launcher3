...
public class Launcher extends Activity
    ...
    private void setupViews() {
        ...
        if (getResources().getBoolean(R.bool.ubtech_tablet_p12)) {
            // 横竖屏切换时，壁纸会出现放大的bug，暂时屏蔽入口
    ...
    private void addAppWidgetFromDrop(PendingAddWidgetInfo info, long container, long screenId,
        ...
        if (hostView != null) {
            ...
            Log.i(TAG, "== bind widget id : " + appWidgetId);

            boolean success = mAppWidgetManager.bindAppWidgetIdIfAllowed(
                    appWidgetId, info.info, options);

            Log.e(TAG, " ==bind widget id state: " + success);
